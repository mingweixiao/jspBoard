...
public class BoardDAO {
	...
	public static List<BoardListModel> selectBoardList(BoardListModel param) {
		List<BoardListModel> list = new LinkedList<BoardListModel>();

		Connection con = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
		
		String sql = "SELECT * FROM ( SELECT ROWNUM AS RNUM, Z.* FROM ( ";
	...
	public static int selectTotalPageCnt(int recoreCnt) {
		int result = 0;
		Connection con = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
